...
/*
 maintains a list of code the current active remote control can send and its action name
*/
Dictionary<unsigned long, String> *activeSenderRemote = new SkipList<unsigned long, String>(-1, key_type_numeric_signed, sizeof(int), sizeof(int), 7);
...
void setup() {
  ...
  activeSenderRemote->insert(0xFF18E7, "up");
